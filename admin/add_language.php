...
<body>
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Add Language</h2>
            <ol class="breadcrumb">
    ...
    <div class="col-md-6 m-auto d-block">
        ...
        <form action="../flutter_crud/addLanguages.php" method="post" enctype="multipart/form-data"
            ...
            <h5>Enter Languages Name:</h5>
            <input type="text" name="name" id="name" placeholder="Enter Languages Name..." class="form-control input" />
            <span id="nameError" class="error"></span>
            <br />

            <h5>Upload Languages Image:</h5>
