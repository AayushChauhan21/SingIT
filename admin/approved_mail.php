...
$nqq = mysqli_query($con, "select * from company_master where coid=$coid");
...
echo smtp_mailer($email, 'Login Now', $message, $con, $coid);
function smtp_mailer($to, $subject, $msg, $con, $coid)
{
    $mail = new PHPMailer();
    $mail->IsSMTP();
    $mail->SMTPAuth = true;
