...
// FIXED API ENDPOINT
$apiUrl = $base_url . "getSongsByCategory.php?gid=" . urlencode($gid);
        ...
        <div class="card custom-card productdesc">
            <div class="card-body h-100">
                <div class="row">
                                        ...
                                        <div class="col-xl-12 mt-4">
                                            <div class="card">
                                                <div class="card-body p-0 mb-3 mt-3">
                                                    ...
                                                    <?php endforeach; else: ?>
                                                    <div class="p-4 border-bottom border-top text-center text-muted">No songs found for this genre.</div>
                                                    <?php endif; ?>
                    ...
                    <?php else: ?>
                        <div class="alert alert-danger">Genre not found or API returned empty data.</div>
                    <?php endif; ?>
